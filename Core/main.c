...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	//	  Verif_Tensiones;										// Verifico tensiones
...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, Dir_485_PSalida_Pin|Dir_485_PC_Pin|AD0_OK_Pin|Test_V_OK_Pin
                          |Modo_Test_Pin|Modo_Trabajo_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, DD0_Pin|DD1_Pin|DD2_Pin|DD3_Pin
                          |DD4_Pin|DD5_Pin|DD6_Pin|DD7_Pin
                          |LCD_RS_Pin|LCD_WR_Pin|LCD_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Columna_0_Pin Columna_1_Pin Columna_2_Pin Columna_3_Pin
                           Columna_4_Pin */
  GPIO_InitStruct.Pin = Columna_0_Pin|Columna_1_Pin|Columna_2_Pin|Columna_3_Pin
                          |Columna_4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
//  __disable_irq();
	...
	Clr_LCD();													/* Borro el LCD */
	Print_LCD(0,0,(int8_t *) "    Phenix  2025    ");
	Print_LCD(0,1,(int8_t *) "ERROR  DMA          ");
